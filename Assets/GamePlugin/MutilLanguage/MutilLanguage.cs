...
// #endif
    ...
    public void reInitRes()
    {
        ...
        if ((languageCode4mutil.CompareTo(langDefault) == 0 || languageCode4mutil.CompareTo("en") == 0) &&
            lset.Length <= 0)
        {
            languageCode4mutil = GameHelper.Instance.languageCode;
    ...
    public static string getStringWithKey(string key, StateCapText stateCap = StateCapText.None,
        FormatText stateFormat = FormatText.None, object obFormat = null, string defaulttxt = "")
    {
