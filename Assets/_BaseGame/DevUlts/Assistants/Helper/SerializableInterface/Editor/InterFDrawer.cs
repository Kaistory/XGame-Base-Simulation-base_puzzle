using DevUlts.Assistants.Helper.SerializableInterface.Main;
using UnityEditor;
using UnityEngine;
using Object = UnityEngine.Object;

namespace DevUlts.Assistants.Helper.SerializableInterface.Editor
{
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Object draggedObject =
                EditorGUI.ObjectField(
                    new Rect(position.position, new Vector2(position.width, EditorGUIUtility.singleLineHeight + 2)),
                    label,
            ...
            if (draggedObject != null)
            {
                ...
                {
                    var component =
                        (draggedObject as GameObject).GetComponent(fieldInfo.FieldType.GetGenericArguments()[0]);
