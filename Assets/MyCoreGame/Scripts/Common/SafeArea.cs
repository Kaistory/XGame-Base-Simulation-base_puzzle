...
namespace Crystal
{
    ...
    /// </summary>
    public class SafeArea : master.Singleton<SafeArea>
    {
        #region Simulations
        ...
        private void RegisterListener()
        {
            ...
            TigerForge.EventManager.StartListening(EventName.OnPurchaseInapp, Refresh);
            TigerForge.EventManager.StartListening(EventName.OnChangeResolution, OnChangeResolution);
        }
        ...
        private void OnChangeResolution()
        {
            ...
            UIManager.Instance.ResetResolution();
            Refresh();
        }

        public bool CheckForNotch()
        {
            ...
            bool hasTopNotch = safeArea.yMin > 0;
            bool hasBottomNotch = safeArea.yMax < screenHeight;

            return hasTopNotch || hasBottomNotch;
        }
        ...
        private void RemoveListener()
        {
            ...
            TigerForge.EventManager.StopListening(EventName.OnPurchaseInapp, Refresh);
            TigerForge.EventManager.StopListening(EventName.OnChangeResolution, OnChangeResolution);
        }
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                float height = mygame.sdk.SdkUtil.GetSizeBanner();
